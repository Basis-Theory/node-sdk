...
describe("TokenIntentsClient", () => {
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.tokenIntents.get("id");
    ...
    test("get (4)", async () => {
        ...
        server.mockEndpoint().get("/token-intents/id").respondWith().statusCode(404).jsonBody(rawResponseBody).build();
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.tokenIntents.delete("id");
        }).rejects.toThrow(BasisTheory.UnauthorizedError);
    });
