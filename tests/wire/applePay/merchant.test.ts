...
describe("Merchant", () => {
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/apple-pay/merchant-registration/id")
            .respondWith()
            .statusCode(200)
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.applePay.merchant.get("id");
    ...
    test("delete (1)", async () => {
        ...
        server.mockEndpoint().delete("/apple-pay/merchant-registration/id").respondWith().statusCode(200).build();

        const response = await client.applePay.merchant.delete("id");
    ...
    test("delete (2)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/apple-pay/merchant-registration/id")
            .respondWith()
            .statusCode(401)
            .jsonBody(rawResponseBody)
            .build();
        ...
        await expect(async () => {
            return await client.applePay.merchant.delete("id");
        }).rejects.toThrow(BasisTheory.UnauthorizedError);
    });
    ...
    test("create (1)", async () => {
        ...
        const response = await client.applePay.merchant.create();
        expect(response).toEqual({
            id: "id",
            tenantId: "tenant_id",
    ...
    test("create (2)", async () => {
        ...
        await expect(async () => {
            return await client.applePay.merchant.create();
        }).rejects.toThrow(BasisTheory.UnauthorizedError);
    });
