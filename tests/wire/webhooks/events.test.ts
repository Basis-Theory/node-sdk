...
describe("Events", () => {
    test("list (1)", async () => {
        ...
        const rawResponseBody = [
            ...
            "apple-pay-merchant.deleted",
            "apple-pay-merchant.retrieved",
            "apple-pay-merchant.certificate.created",
            "apple-pay-merchant.certificate.deleted",
            "apple-pay-merchant.certificate.retrieved",
            "application.created",
            "application.updated",
            "application.deleted",
            ...
            "google-pay-merchant.registered",
            "google-pay-merchant.deleted",
            "google-pay-merchant.retrieved",
            "google-pay-merchant.certificate.created",
            "google-pay-merchant.certificate.deleted",
            "google-pay-merchant.certificate.retrieved",
            "http.request",
