...
export class Data {
     ...
     * @param {Data.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public async get(documentId: string, requestOptions?: Data.RequestOptions): Promise<void> {
