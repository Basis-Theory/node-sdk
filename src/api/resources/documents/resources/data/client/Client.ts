...
export class Data {
    protected readonly _options: Data.Options;

    constructor(_options: Data.Options = {}) {
     ...
     */
    public get(documentId: string, requestOptions?: Data.RequestOptions): core.HttpResponsePromise<stream.Readable> {
