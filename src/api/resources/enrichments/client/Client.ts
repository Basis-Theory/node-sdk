...
export class EnrichmentsClient {
    ...
    /**
     * @param {BasisTheory.EnrichmentsCardDetailsRequest} request
     * @param {EnrichmentsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link BasisTheory.UnauthorizedError}
     * @throws {@link BasisTheory.ForbiddenError}
    ...
    public cardDetails(
        ...
        return core.HttpResponsePromise.fromPromise(this.__cardDetails(request, requestOptions));
    }

    private async __cardDetails(
        request: BasisTheory.EnrichmentsCardDetailsRequest,
        requestOptions?: EnrichmentsClient.RequestOptions,
