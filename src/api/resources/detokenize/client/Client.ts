...
export declare namespace Detokenize {
    interface Options {
...
export class Detokenize {
    constructor(protected readonly _options: Detokenize.Options = {}) {}

    /**
     * @param {unknown} request
     * @param {Detokenize.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *     })
     */
    public async detokenize(request?: unknown, requestOptions?: Detokenize.RequestOptions): Promise<void> {
