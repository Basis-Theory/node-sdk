...
export class Googlepay {
    constructor(protected readonly _options: Googlepay.Options = {}) {}

    /**
     * @param {BasisTheory.GooglePayTokenizeRequest} request
    ...
    public async tokenize(
    ...
    ): Promise<BasisTheory.GooglePayTokenizeResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.GooglePayTokenizeRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        if (_response.ok) {
            return serializers.GooglePayTokenizeResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling POST /connections/google-pay/tokenize.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
