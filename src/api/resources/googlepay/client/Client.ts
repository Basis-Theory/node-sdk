...
export class Googlepay {
    ...
    ): core.HttpResponsePromise<BasisTheory.GooglePayTokenizeResponse> {
    ...
    private async __tokenize(
        request: BasisTheory.GooglePayTokenizeRequest = {},
        requestOptions?: Googlepay.RequestOptions,
    ): Promise<core.WithRawResponse<BasisTheory.GooglePayTokenizeResponse>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.GooglePayTokenizeRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.GooglePayTokenizeResponse.parseOrThrow(_response.body, {
