...
export class ApplicationTemplates {
    ...
    public async list(
    ...
    ): Promise<BasisTheory.ApplicationTemplate[]> {
        ...
        if (_response.ok) {
            return serializers.applicationTemplates.list.Response.parseOrThrow(_response.body, {
    ...
    public async get(
        ...
        if (_response.ok) {
            return serializers.ApplicationTemplate.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
