...
export class Webhooks {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.Webhook, rawResponse: _response.rawResponse };
        }
    ...
    private async __list(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.WebhookList, rawResponse: _response.rawResponse };
        }
