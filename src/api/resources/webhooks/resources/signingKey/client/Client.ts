...
export class SigningKey {
    constructor(protected readonly _options: SigningKey.Options = {}) {}

    /**
     * Returns the signing key
     *
     * @param {SigningKey.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.webhooks.signingKey.get()
     */
    public async get(requestOptions?: SigningKey.RequestOptions): Promise<string> {
