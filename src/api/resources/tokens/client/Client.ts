...
export class Tokens {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as BasisTheory.TokenPaginatedList,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.Token, rawResponse: _response.rawResponse };
        }
    ...
    public async listV2(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as BasisTheory.TokenCursorPaginatedList,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
