...
export class Certificates {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling GET /apple-pay/merchant-registration/{merchantId}/certificates/{id}.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
    ...
    private async __delete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling DELETE /apple-pay/merchant-registration/{merchantId}/certificates/{id}.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
                    message: _response.error.errorMessage,
    ...
    private async __create(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling POST /apple-pay/merchant-registration/{merchantId}/certificates.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
                    message: _response.error.errorMessage,
