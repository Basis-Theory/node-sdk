...
import { DomainClient } from "../resources/domain/client/Client.js";
import { MerchantClient } from "../resources/merchant/client/Client.js";
import { SessionClient } from "../resources/session/client/Client.js";
...
export class ApplePayClient {
    ...
    protected _domain: DomainClient | undefined;
    protected _session: SessionClient | undefined;
    ...
    public get domain(): DomainClient {
        return (this._domain ??= new DomainClient(this._options));
    }

    public get session(): SessionClient {
        return (this._session ??= new SessionClient(this._options));
    }
    ...
    private async __create(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/apple-pay");
    }
    ...
    private async __get(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/apple-pay/{id}");
    }
     ...
     */
    public delete(id: string, requestOptions?: ApplePayClient.RequestOptions): core.HttpResponsePromise<string> {
    ...
    private async __delete(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/apple-pay/{id}");
    }
}
