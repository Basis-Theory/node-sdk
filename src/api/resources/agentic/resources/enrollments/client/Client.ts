...
export class Enrollments {
    ...
    ): core.HttpResponsePromise<BasisTheory.EnrollmentList> {
    ...
    private async __list(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError("Timeout exceeded when calling GET /enrollments.");
            case "unknown":
                throw new errors.BasisTheoryError({
    ...
    private async __create(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError("Timeout exceeded when calling POST /enrollments.");
            case "unknown":
                throw new errors.BasisTheoryError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.BasisTheoryEnvironment.Default,
                `enrollments/${core.url.encodePathParam(enrollmentId)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling GET /enrollments/{enrollment_id}.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
                    message: _response.error.errorMessage,
    ...
    private async __delete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling DELETE /enrollments/{enrollment_id}.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
                    message: _response.error.errorMessage,
    ...
    private async __retry(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.BasisTheoryEnvironment.Default,
                `enrollments/${core.url.encodePathParam(enrollmentId)}/retry`,
            ),
            method: "POST",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling POST /enrollments/{enrollment_id}/retry.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
                    message: _response.error.errorMessage,
