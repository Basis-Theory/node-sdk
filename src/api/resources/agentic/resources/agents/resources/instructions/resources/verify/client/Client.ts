...
export class Verify {
    ...
    private async __start(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `agents/${core.url.encodePathParam(agentId)}/instructions/${core.url.encodePathParam(instructionId)}/verify`,
            ),
            method: "POST",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling POST /agents/{agent_id}/instructions/{instruction_id}/verify.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
    ...
    private async __passkey(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.BasisTheoryEnvironment.Default,
                `agents/${core.url.encodePathParam(agentId)}/instructions/${core.url.encodePathParam(instructionId)}/verify/passkey`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling POST /agents/{agent_id}/instructions/{instruction_id}/verify/passkey.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
                    message: _response.error.errorMessage,
