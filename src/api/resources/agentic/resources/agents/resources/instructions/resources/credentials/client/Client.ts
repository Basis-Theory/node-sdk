    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `agentic/agents/${core.url.encodePathParam(agentId)}/instructions/${core.url.encodePathParam(instructionId)}/credentials`,
            ),
            method: "POST",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError(
                    "Timeout exceeded when calling POST /agentic/agents/{agent_id}/instructions/{instruction_id}/credentials.",
                );
            case "unknown":
                throw new errors.BasisTheoryError({
