...
export class Sessions {
    ...
    private async __create(
        ...
        if (_response.ok) {
            return {
                data: _response.body as BasisTheory.CreateThreeDsSessionResponse,
    ...
    private async __authenticate(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.ThreeDsAuthentication, rawResponse: _response.rawResponse };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.ThreeDsSession, rawResponse: _response.rawResponse };
        }
