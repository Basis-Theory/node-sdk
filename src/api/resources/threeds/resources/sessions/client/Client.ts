...
export class Sessions {
     ...
     * @param {BasisTheory.threeds.AuthenticateThreeDsSessionRequest} request
    ...
    public async authenticate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.threeds.AuthenticateThreeDsSessionRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
     ...
     */
    public async get(id: string, requestOptions?: Sessions.RequestOptions): Promise<BasisTheory.ThreeDsSession> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
