...
export class TokenIntents {
     ...
     */
    public async get(id: string, requestOptions?: TokenIntents.RequestOptions): Promise<BasisTheory.TokenIntent> {
        ...
        if (_response.ok) {
            return serializers.TokenIntent.parseOrThrow(_response.body, {
