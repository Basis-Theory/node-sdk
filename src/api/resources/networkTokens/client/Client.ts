...
export class NetworkTokens {
    ...
    public async create(
    ...
    ): Promise<BasisTheory.NetworkToken> {
        ...
        if (_response.ok) {
            return serializers.NetworkToken.parseOrThrow(_response.body, {
     ...
     */
    public async get(id: string, requestOptions?: NetworkTokens.RequestOptions): Promise<BasisTheory.NetworkToken> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
     ...
     */
    public async delete(id: string, requestOptions?: NetworkTokens.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
     ...
     */
    public async suspend(id: string, requestOptions?: NetworkTokens.RequestOptions): Promise<BasisTheory.NetworkToken> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
     ...
     */
    public async resume(id: string, requestOptions?: NetworkTokens.RequestOptions): Promise<BasisTheory.NetworkToken> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
