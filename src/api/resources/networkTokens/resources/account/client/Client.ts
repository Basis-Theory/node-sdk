...
export class AccountClient {
    ...
    ): core.HttpResponsePromise<BasisTheory.NetworkTokenAccount> {
    ...
    private async __get(
        id: string,
        requestOptions?: AccountClient.RequestOptions,
    ): Promise<core.WithRawResponse<BasisTheory.NetworkTokenAccount>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `network-tokens/${core.url.encodePathParam(id)}/account`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.NetworkTokenAccount.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/network-tokens/{id}/account");
    }
}
