...
export class Session {
    ...
    /**
     * @param {BasisTheory.connections.applePay.ApplePaySessionRequest} request
    ...
    public async create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.connections.applePay.ApplePaySessionRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return serializers.connections.applePay.session.create.Response.parseOrThrow(_response.body, {
