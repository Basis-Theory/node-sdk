...
export class Domain {
    ...
    /**
     * @param {BasisTheory.connections.applePay.ApplePayDomainDeregistrationRequest} request
    ...
    public async deregister(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.connections.applePay.ApplePayDomainDeregistrationRequest.jsonOrThrow(request, {
    ...
    /**
     * @param {BasisTheory.connections.applePay.ApplePayDomainRegistrationRequest} request
     * @param {Domain.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async register(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.connections.applePay.ApplePayDomainRegistrationRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
