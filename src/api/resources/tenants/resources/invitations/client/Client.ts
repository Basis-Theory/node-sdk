...
export class Invitations {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as BasisTheory.TenantInvitationResponsePaginatedList,
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.TenantInvitationResponse, rawResponse: _response.rawResponse };
        }
