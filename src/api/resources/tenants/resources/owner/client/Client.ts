...
export class Owner {
    protected readonly _options: Owner.Options;

    constructor(_options: Owner.Options = {}) {
     ...
     */
    public get(requestOptions?: Owner.RequestOptions): core.HttpResponsePromise<BasisTheory.TenantMemberResponse> {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.TenantMemberResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BasisTheoryTimeoutError("Timeout exceeded when calling GET /tenants/self/owner.");
            case "unknown":
                throw new errors.BasisTheoryError({
