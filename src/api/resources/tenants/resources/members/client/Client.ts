...
export class MembersClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<BasisTheory.TenantMemberResponse, BasisTheory.TenantMemberResponsePaginatedList>> {
        ...
        return new core.Page<BasisTheory.TenantMemberResponse, BasisTheory.TenantMemberResponsePaginatedList>({
