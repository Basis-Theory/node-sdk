...
export class Jobs {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.AccountUpdaterJob, rawResponse: _response.rawResponse };
        }
    ...
    private async __list(
        ...
        if (_response.ok) {
            return { data: _response.body as BasisTheory.AccountUpdaterJobList, rawResponse: _response.rawResponse };
        }
