...
export class Jobs {
     ...
     */
    public async get(id: string, requestOptions?: Jobs.RequestOptions): Promise<BasisTheory.AccountUpdaterJob> {
        ...
        if (_response.ok) {
            return serializers.AccountUpdaterJob.parseOrThrow(_response.body, {
    ...
    public async list(
    ...
    ): Promise<BasisTheory.AccountUpdaterJobList> {
        ...
        if (_response.ok) {
            return serializers.AccountUpdaterJobList.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
     ...
     */
    public async create(requestOptions?: Jobs.RequestOptions): Promise<BasisTheory.AccountUpdaterJob> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
