...
export const ReactorRuntime: core.serialization.ObjectSchema<
    serializers.ReactorRuntime.Raw,
    BasisTheory.ReactorRuntime
...
export declare namespace ReactorRuntime {
